...
const Testimonials = (props) => {
    ...
    return(
        <Container fluid className={`section-block testimonials ${props.className ? props.className : ''}`}>
            {/* <Image alt='Envelope' src='/images/testimonial-envelope.png' className='envelope' /> */}
            <Row> 
            ...
            <Row className='three-col-row'> 
                <Col xs={12} md={4}>
                    <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Vikramjit' width={100} height={100} fluid src='/images/student1-small.webp' />
                ...
                <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Rohan' width={100} height={100} fluid src='/images/student2-small.webp' />
                ...
                <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='C.B.' width={100} height={100} fluid src='/images/student8-small.webp' />
        ...
        <Container fluid className={`section-block testimonials ${props.className ? props.className : ''}`}>
            ...
            <Row className='three-col-row'> 
                <Col xs={12} md={4}>
                    <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Alok' fluid roundedCircle src='/images/alok.webp' />
                ...
                <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Namrata' fluid roundedCircle src='/images/namrata.webp' />
                ...
                <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Ashutosh' fluid roundedCircle src='/images/ashutosh.webp' />
            ...
            <Row className='three-col-row'> 
                <Col xs={12} md={4}>
                    <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Aadit' fluid roundedCircle src='/images/aadit.webp' />
                ...
                <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Onkar' fluid roundedCircle src='/images/onkar.webp' />
                ...
                <Card className='nomad-card'>
                        <Card.Body>
                            <Image alt='Nitin' fluid roundedCircle src='/images/nitin.webp' />
        ...
        <Container fluid className={`section-block testimonials ${props.className ? props.className : ''}`}>
            ...
            <Row className='three-col-row'> 
                <Col xs={12} md={6}>
                    <Card className='nomad-card'>
                        <Card.Body>
                            {/*<Image fluid roundedCircle src='https://placehold.co/100x100' />*/}
