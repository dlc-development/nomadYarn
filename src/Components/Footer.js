...
const Footer = (props) => {
    ...
    return(
        <Container className='footer' style={{paddingTop:'50px'}}>
            <a href="https://wa.me/919209462807?text=%20I'm%20interested%20in%20Nomad%20Credit's%20help" target="_blank" style={{position: 'fixed', right:'20px', bottom:'20px', width:'50px', height:'50px'}}><Image style={{width:'50px', height:'50px'}} src='/images/whatsapp-icon.png' /></a>
