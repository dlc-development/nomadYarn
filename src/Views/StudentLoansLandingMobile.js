...
const StudentLoansLandingMobile = (props) => {
    ...
    return(
        ...
        <Helmet>
            ...
            <Container fluid className='secondary-hero section-block  position-relative'>
                ...
                <Row className='three-col-row'>
                    <Col>
                        <h1 className='hero-header'>Find the Best Study Abroad Student Loans for 2023</h1>
            ...
            <Container fluid className='easy-process-section section-block' style={{paddingTop:'20px', paddingBottom:'20px'}}>
                <Row className='three-col-row'>
                    <Col xs={12} md={6}>
                        ...
                        <ul>
                            <li>Get personalized service from an experienced team with local United States-based knowledge</li>
                    ...
                    <Col xs={12} md={6}>
                        <Image alt="Nomad Credit show International Students how studying abroad works" width={578} height={550} fluid src={`/images/loans-landing-get-advice-${imgSize}.webp`} />
                    </Col> 
                </Row>
            </Container>
            {/* <ScheduleNowBanner /> */}
...
export default StudentLoansLandingMobile