...
const StudentLoansLandingAustralia = (props) => {
    ...
    return(
        ...
        <>
            ...
            <Container fluid className='secondary-hero section-block  position-relative'>
                ...
                <Row className='three-col-row'>
                    <Col>
                        <h1 className='hero-header'>Study Abroad in Australia - Find the Best Student Loans for 2023</h1>
                ...
                <Row className='mt-5 three-col-row'>
                    ...
                    <Col >
                        <LoanLandingForm landingName="/student-loans-landing-australia" />
                    </Col>
            ...
            <LoanBottomForm landingName="loan-landing-austrailia" />
        </>
    )
}
export default StudentLoansLandingAustralia