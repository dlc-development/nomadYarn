                            ...
                            return(
                                <form key={i} id={x} onSubmit={e => {
                                    ...
                                    fetch(`/api/v1/mydocs`,
                                        ...
                                        .then(response =>
                                            {
                                                console.log('mydocs upload', response)
                                                if(response.status === "created") window.location.href = '/my-documents'
                                            }
                                        )
                                    ...
                                    = hidden_field_tag 'mydoc[category]', section */}
                                    ...
                                    <Row  className='three-col-row doc-upload-row'>
                                        ...
                                        <Col xs={12} md={2}  className="description">{thisObj.description} </Col>
                                            ...
                                            <Col xs={12} md={4}><Form.Control required name='mydoc[file]' type="file" placeholder={x} /> </Col>
                                            <Col xs={12} md={2}>
