    ...
    return(
        ...
        <>
            ...
            <Container fluid className='secondary-hero section-block  position-relative'>
                ...
                <Row className='mt-5 three-col-row'>
                    ...
                    <Col xs={12} md={6}>
                        ...
                        <Image alt='City' width={578} height={436} fluid className='mt-5 display-desktop' src={`/images/how-it-works-${imgSize}.webp`} />
                    </Col>
                    <Col >
            ...
            <Container style={{fontSize:'large', textAlign:'center'}} className='section-block'>
                <Row>
                    <Col sm={12} md={4}><Image src='/images/prodigy/prodigy-interest-rate.webp' alt='interest rate icon' /><h2>Interest Rate</h2><p>10.75% onwards</p></Col>
                    <Col sm={12}  md={4}><Image src='/images/prodigy/prodigy-processing-fees.webp' alt='processing fees icon' /><h2>Processing Fees</h2><p>around 1-2% <br /><small>of your total loan amount</small></p></Col>
                    <Col  sm={12}  md={4}><Image src='/images/prodigy/prodigy-loan-margin.webp' alt='loan margin icon' /><h2>Margin Money</h2><p>0%</p></Col>
                </Row>
            </Container>
            {/* <Testimonials /> */}
