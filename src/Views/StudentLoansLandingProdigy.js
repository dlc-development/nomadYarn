        ...
        <>
         <Helmet>
            ...
            <Container style={{fontSize:'large', textAlign:'center'}} className='section-block'>
                <Row>
                    <Col><Image src='/images/prodigy/prodigy-interest-rate.webp' alt='interest rate Icon' /><h2>Interest Rate</h2><p>Starting at 11.06%</p></Col>
                    <Col><Image src='/images/prodigy/prodigy-processing-fees.webp' alt='processing fees icon' /><h2>Processing Fees</h2><p>2.5% - 4% Range</p></Col>
                    <Col><Image src='/images/prodigy/prodigy-loan-margin.webp' alt='loan margin icon' /><h2>Loan Margin</h2><p>0%</p></Col>
                </Row>
            </Container>
            {/* <Testimonials /> */}
